            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="cat_id">
                                @foreach($data as $v)
                                <option value="{{$v['id']}}"
                                    @if($info->id == $v->id) selected @endif
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="art_title" value="{{$info->art_title}}">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>描述：</th>
                        <td>
                            <textarea name="art_desc"> {{$info->art_desc}}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>关键词：</th>
                        <td><input type="text" class="lg" name="art_tag" value="{{$info->art_tag}}"></td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>缩略图：</th>
                        <td>
                            <input type="hidden" size="50" name="art_thumb" value="{{$info->art_thumb}}">
                    ...
                    <tr>
                        <th></th>
                        <td><img src="/{{$info->art_thumb}}" alt="" id="art_thumb_img" width="200"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>作者：</th>
                        <td><input type="text" class="lg" name="art_editor" value="{{$info->art_editor}}"></td>
                    </tr>
                    <tr>
                        <th></th>
                        <td>
