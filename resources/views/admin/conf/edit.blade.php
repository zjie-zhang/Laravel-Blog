...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/conf/'.$info['id'])}}" method="post">
            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text"  name="conf_name" value="{{$info['conf_title']}}">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="conf_name" value="{{$info['conf_name']}}">
                    ...
                    <tr class="field_value">
                        ...
                        <td>
                            <input type="text" class="lg" name="field_value" value="{{$info['field_value']}}"><br>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="conf_order"  value="{{$info['conf_order']}}"></td>
                    </tr>
                    <tr>
                        <th>说明：</th>
                        <td><textarea name="conf_tips" id="" cols="30" rows="10">{{$info['conf_tips']}}</textarea></td>
                    </tr>
                    <tr>
                        <th></th>
                        <td>
